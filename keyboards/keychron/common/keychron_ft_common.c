...
__attribute__((weak)) void KEYBOARD_non_light_factory_reset_indicator(void){

}
__attribute__((weak)) void KEYBOARD_non_light_led_update(void){
}
...
static void factory_reset(void) {
    ...
    led_matrix_init();
	led_matrix_set_value_all(0);//UINT8_MAX
...
static void timer_300ms_task(void) {
	...
	if(factory_reset_count>0)
        KEYBOARD_non_light_factory_reset_indicator();
